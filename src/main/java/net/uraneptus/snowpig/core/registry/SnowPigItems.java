...
public class SnowPigItems {
    ...
    public static final Item FROZEN_PORKCHOP = register("frozen_porkchop", new Item(new Item.Settings().food(FROZZEN_MEAT)));
    public static final Item FROZEN_HAM = register("frozen_ham", new FrozenHamItem(2, -1.2F, new Item.Settings().food(FROZZEN_MEAT)));
